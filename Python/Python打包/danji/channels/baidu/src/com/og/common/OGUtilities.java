...
public class OGUtilities {
	...
	public static void shutDown() {
		...
		OGMainActivity.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
            	try {
            		Log.d("123", "======== 22222222 shutDown ========");
            		DKPlatform.getInstance().bdgameExit(OGMainActivity.getInstance(), new IDKSDKCallBack() {
            			@Override
            			public void onResponse(String paramString) {
            				Log.d("123", "======== 22222222 shutDown onResponse========");
            				Toast.makeText(OGMainActivity.getInstance(), "退出游戏", Toast.LENGTH_LONG).show();
