...
import com.anzhi.usercenter.sdk.OutGameAdActivity;
...
public class OGUtilities {
	...
	public static void shutDown() {
		OGMainActivity.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    AnzhiUserCenter.getInstance().setmAzOutGameInter(new AzOutGameInter() {
                        
                        @Override
                        public void azOutGameInter(int arg0) {
                            // TODO Auto-generated method stub
                        	OGMainActivity.getInstance().finish();
                            OGMainActivity.getInstance().onDestroy();
                            android.os.Process.killProcess(android.os.Process.myPid());
                        }});

                    Reflect.on(AnzhiUserCenter.getInstance()).set("a", true);
                    Intent intent = new Intent(OGMainActivity.getInstance(), OutGameAdActivity.class);
